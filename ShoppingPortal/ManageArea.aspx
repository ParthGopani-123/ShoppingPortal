<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageArea.aspx.cs" Inherits="ManageArea" Title="Area"
...
<%@ Register Src="~/CCManageCity.ascx" TagName="ManageCityPopup" TagPrefix="MCC" %>
<%@ Register Src="~/CCManageArea.ascx" TagName="ManageAreaPopup" TagPrefix="MA" %>
            ...
            <div class="row">
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdArea" AllowPaging="false" runat="server" OnRowDataBound="grdArea_OnRowDataBound"
                            OnSelectedIndexChanged="grdArea_OnSelectedIndexChanged" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AreaId" HeaderText="AreaId" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:TemplateField HeaderText="Area">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditArea" CssClass="lnkEditArea" OnClick="lnkEditArea_OnClick"
								...
								<asp:TemplateField HeaderText="City">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditCity" CssClass="lnkEditCity" OnClick="lnkEditCity_OnClick"
                                            runat="server"></asp:LinkButton>
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
                ...
                <div class="modal-dialog">
                    <div class="modal-content darkmodel">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-7">
                                        <div class="checkbox-custom">
                                            <asp:CheckBox ID="chkReplace" Text="Replace Area if Any" runat="server" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8">
                                        <label class="text-danger">
                                            * You can not change <b>Country Name, State Name, City Name</b> and <b>Area Name</b>
                                            by Excel</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <a href="Download/Area Sample.xls" data-toggle="tooltip" title="Download Sample File"
                                class="pull-left btn btn-raised btn-download tooltips"><i class="fa fa-download"></i></a>
                            <button type="button" class="ClosePopup btn btn-raised btn-default">
                                Cancel</button>
                            <asp:Button ID="btnUpload" OnClick="btnUpload_OnClick" runat="server" CssClass="btn btn-raised btn-save clickloader"
                                Text="Save" />
                        </div>
                    </div>
                </div>
	...
	<asp:LinkButton ID="lnkFackCity" runat="server"> </asp:LinkButton>
    <cc1:ModalPopupExtender ID="popupCity" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID6"
        PopupControlID="pnlpopupCity" TargetControlID="lnkFackCity" BackgroundCssClass="modalBackground">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="pnlpopupCity" runat="server" CssClass="modelpopup col-lg-4 col-md-4 col-sm-8 col-xs-12 p0"
        Style="display: none">
        <MCC:ManageCityPopup ID="popupManageCity" runat="server" />
    </asp:Panel>

    <asp:LinkButton ID="lnkFackArea" runat="server"> </asp:LinkButton>
    <cc1:ModalPopupExtender ID="popupArea" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID7"
        PopupControlID="pnlpopupArea" TargetControlID="lnkFackArea" BackgroundCssClass="modalBackground">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="pnlpopupArea" runat="server" CssClass="modelpopup col-lg-4 col-md-4 col-sm-8 col-xs-12 p0"
        Style="display: none">
        <MA:ManageAreaPopup ID="popupManageArea" runat="server" />
    </asp:Panel>
</asp:Content>
    ...
    <script type="text/javascript">
        function AddControl() {
            if ($(".lnkAdd").attr("class") != undefined) {
                ...
                ShowPopupAndLoader(6, "divloaderArea");
                return true;
            }
            else {
                return false;
        ...
        function Checkpostback() {
			...
			$(".lnkEditCity").click(function () {
				ShowPopupAndLoader(6, "divloaderCity");
				return true;
			});

            $(".lnkEditArea").click(function () {
                ShowPopupAndLoader(7, "divloaderArea");
                return true;
			});
