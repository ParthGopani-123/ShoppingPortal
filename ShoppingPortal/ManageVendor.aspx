<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageVendor.aspx.cs" Inherits="ManageVendor" Title="Vendor" EnableEventValidation="false" %>
            ...
            <div class="row">
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdVendor" AllowPaging="false" runat="server" OnRowDataBound="grdVendor_RowDataBound"
                            OnSelectedIndexChanged="grdVendor_SelectedIndexChanged" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="VendorId" HeaderText="VendorId" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:TemplateField HeaderText="Vendor">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditVendor" CssClass="lnkEditVendor" OnClick="lnkEditVendor_Click"
                                            runat="server"></asp:LinkButton>
                                        <asp:Literal ID="ltrVendor" runat="server"></asp:Literal>
                                    </ItemTemplate>
                                </asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:LinkButton ID="lnkFackVendor" runat="server"> </asp:LinkButton>
            <cc1:ModalPopupExtender ID="popupVendor" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID2"
                PopupControlID="pnlpopupVendor" TargetControlID="lnkFackVendor" BackgroundCssClass="modalBackground">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="pnlpopupVendor" runat="server" DefaultButton="btnSave" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
                Style="display: none">
                    ...
                    <div class="modal-content darkmodel">
                        <div class="modal-header bg-black">
                            ...
                            <h4 class="modal-title">
                                <asp:Label ID="lblPopupTitle" runat="server">Vendor</asp:Label></h4>
                        </div>
                        <div class="modal-body divloaderVendor checkvalidVendor">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-7">
                                            <asp:TextBox ID="txtVendorName" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=Vendor"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-7">
                                            <asp:TextBox ID="txtMobileNo" CssClass="form-control intnumber"
    ...
    <script type="text/javascript">
        function AddControl() {
            if ($(".lnkAdd").attr("class") != undefined) {
                ...
                ShowPopupAndLoader(2, "divloaderVendor");
                return true;
            }
            else {
                return false;
        ...
        function Checkpostback() {
            ...
            $(".btnSave").click(function () {
                if (CheckValidation("checkvalidVendor")) {
                    addLoader('btnSave');
                    return true;
                }
                else {
