<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageCountry.aspx.cs" Inherits="ManageCountry" Title="Country" EnableEventValidation="false" %>
            ...
            <div class="row">
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdCountry" AllowPaging="false" runat="server" OnRowDataBound="grdCountry_OnRowDataBound"
                            OnSelectedIndexChanged="grdCountry_OnSelectedIndexChanged" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CountryId" HeaderText="CountryId" HeaderStyle-CssClass="hide"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-7">
                                        <div class="checkbox-custom">
                                            <asp:CheckBox ID="chkReplace" Text="Replace Country if Any" runat="server" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8">
                                        <label class="text-danger">
                                            * You can not change <b>Country Name</b> by Excel</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <a href="Download/Country Sample.xls" data-toggle="tooltip" title="Download Sample File"
