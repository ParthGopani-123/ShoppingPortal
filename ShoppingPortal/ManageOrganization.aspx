<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
	CodeFile="ManageOrganization.aspx.cs" Inherits="ManageOrganization" Title="Organization" EnableEventValidation="false" %>
			...
			<div class="row">
				...
				<div class="page-content col-md-12 divtable divloader">
					<div class="table-responsive tabHeight1 fixheight2">
						<asp:GridView ID="grdOrganization" AllowPaging="false" runat="server" OnRowDataBound="grdOrganization_OnRowDataBound"
							OnSelectedIndexChanged="grdOrganization_OnSelectedIndexChanged" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundField DataField="OrganizationId" HeaderText="OrganizationId" HeaderStyle-CssClass="hide"
									ItemStyle-CssClass="hide" />
								<asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
									ItemStyle-CssClass="hide" />
								<asp:TemplateField HeaderText="Organization">
									<ItemTemplate>
										<asp:LinkButton ID="lnkEditOrganization" CssClass="lnkEditOrganization" OnClick="lnkEditOrganization_OnClick"
											runat="server"></asp:LinkButton>
										<asp:Literal ID="ltrOrganization" runat="server"></asp:Literal>
									</ItemTemplate>
								</asp:TemplateField>
								<asp:BoundField DataField="OrgUId" HeaderText="Unique Id" />
							</Columns>
							<EmptyDataTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
	<asp:UpdatePanel ID="UpdatePanel2" runat="server">
		<ContentTemplate>
			...
			<asp:LinkButton ID="lnkFackOrganization" runat="server"> </asp:LinkButton>
			<cc1:ModalPopupExtender ID="popupOrganization" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID2"
				PopupControlID="pnlpopupOrganization" TargetControlID="lnkFackOrganization" BackgroundCssClass="modalBackground">
			</cc1:ModalPopupExtender>
			<asp:Panel ID="pnlpopupOrganization" runat="server" DefaultButton="btnSave" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
				Style="display: none">
					...
					<div class="modal-content darkmodel">
						<div class="modal-header bg-black">
							...
							<h4 class="modal-title">
								<asp:Label ID="lblPopupTitle" runat="server">Organization</asp:Label></h4>
						</div>
						<div class="modal-body divloaderOrganization checkvalidOrganizationDetail">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-8 col-md-8 col-sm-7">
											<asp:TextBox ID="txtOrganizationName" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=Organization Name"
												runat="server" MaxLength="50" placeholder="Enter Organization"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-8 col-md-8 col-sm-7">
											<asp:TextBox ID="txtOrgUId" CssClass="form-control" ZValidation="e=blur|v=IsNumber|m=Unique Id"
												runat="server" MaxLength="10" placeholder="Enter Unique Id"></asp:TextBox>
										</div>
									</div>
								</div>
							</div>
	...
	<script type="text/javascript">
		function AddControl() {
			if ($(".lnkAdd").attr("class") != undefined) {
				...
				ShowPopupAndLoader(2, "divloaderOrganization");
				return true;
			}
			else {
				return false;
		...
		function Checkpostback() {
			...
			$(".lnkEditOrganization").click(function () {
				ShowPopupAndLoader(2, "divloaderOrganization");
				return true;
			});

			$(".btnSave").click(function () {
				if (CheckValidation("checkvalidOrganizationDetail")) {
					addLoader('btnSave');
					return true;
				}
				else {
