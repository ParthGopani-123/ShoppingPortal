<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
	CodeFile="ManageFirm.aspx.cs" Inherits="ManageFirm" Title="Firm" EnableEventValidation="false" %>
			...
			<div class="row">
				...
				<div class="page-content col-md-12 divtable divloader">
					<div class="table-responsive tabHeight1 fixheight2">
						<asp:GridView ID="grdFirm" AllowPaging="false" runat="server" OnRowDataBound="grdFirm_OnRowDataBound"
							OnSelectedIndexChanged="grdFirm_OnSelectedIndexChanged" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundField DataField="FirmId" HeaderText="FirmId" HeaderStyle-CssClass="hide"
									ItemStyle-CssClass="hide" />
								<asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
									ItemStyle-CssClass="hide" />
								<asp:TemplateField HeaderText="Firm">
									<ItemTemplate>
										<asp:LinkButton ID="lnkEditFirm" CssClass="lnkEditFirm" OnClick="lnkEditFirm_OnClick"
											runat="server"></asp:LinkButton>
										<asp:Literal ID="ltrFirm" runat="server"></asp:Literal>
									</ItemTemplate>
								</asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
	<asp:UpdatePanel ID="UpdatePanel2" runat="server">
		<ContentTemplate>
			...
			<asp:LinkButton ID="lnkFackFirm" runat="server"> </asp:LinkButton>
			<cc1:ModalPopupExtender ID="popupFirm" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID2"
				PopupControlID="pnlpopupFirm" TargetControlID="lnkFackFirm" BackgroundCssClass="modalBackground">
			</cc1:ModalPopupExtender>
			<asp:Panel ID="pnlpopupFirm" runat="server" DefaultButton="btnSave" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
				Style="display: none">
					...
					<div class="modal-content darkmodel">
						<div class="modal-header bg-black">
							...
							<h4 class="modal-title">
								<asp:Label ID="lblPopupTitle" runat="server">Firm</asp:Label></h4>
						</div>
						<div class="modal-body divloaderFirm checkvalidFirmDetail">
							<div class="form-horizontal">
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-8 col-md-8 col-sm-7">
											<asp:DropDownList ID="ddlOrganization" CssClass="form-control" ZValidation="e=change|v=IsSelect|m=Organization"
												runat="server">
											</asp:DropDownList>
										</div>
									</div>
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-8 col-md-8 col-sm-7">
											<asp:TextBox ID="txtFirmName" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=Firm Name"
												runat="server" MaxLength="50" placeholder="Enter Firm"></asp:TextBox>
										</div>
									</div>
								</div>
	...
	<script type="text/javascript">
		function AddControl() {
			if ($(".lnkAdd").attr("class") != undefined) {
				...
				ShowPopupAndLoader(2, "divloaderFirm");
				return true;
			}
			else {
				return false;
		...
		function Checkpostback() {
			...
			$(".btnSave").click(function () {
				if (CheckValidation("checkvalidFirmDetail")) {
					addLoader('btnSave');
					return true;
				}
				else {
