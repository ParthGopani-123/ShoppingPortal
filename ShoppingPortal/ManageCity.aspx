<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageCity.aspx.cs" Inherits="ManageCity" Title="City"
            ...
            <div class="row">
                <div class="page-header clearfix">
                    ...
                    <div note-colspan="note-colspan-class" class="search-tools divShowSearch note-colspan-class">
                        <asp:Panel ID="pnlSearch" runat="server" DefaultButton="lnkSearch" class="divsearchloader"
                            ...
                            <div class="padbm" note-colspan="note-colspan-class">
                                <div class="input-group">
                                    <asp:DropDownList ID="ddlSearchState" CssClass="form-control" runat="server" note-colspan="note-colspan-class">
                                    </asp:DropDownList>
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdCity" AllowPaging="false" runat="server" OnRowDataBound="grdCity_OnRowDataBound"
                            OnSelectedIndexChanged="grdCity_OnSelectedIndexChanged" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CityId" HeaderText="CityId" HeaderStyle-CssClass="hide"
                ...
                <div class="modal-dialog">
                    <div class="modal-content darkmodel">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-7">
                                        <div class="checkbox-custom">
                                            <asp:CheckBox ID="chkReplace" Text="Replace City if Any" runat="server" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-8">
                                        <label class="text-danger">
                                            * You can not change <b>Country Name, State Name</b> and <b>City Name</b>
                                            by Excel</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <a href="Download/City Sample.xls" data-toggle="tooltip" title="Download Sample File"
