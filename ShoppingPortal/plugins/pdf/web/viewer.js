...
//var Path = 'http://localhost:59473/SchoolWebSite/Student/';
var Path = $(".lblStaticFilePath").text()+"plugins/";
var FilePath = $('.lblFilePath').text();//Path + 'pdf/web/myfile.pdf';
//alert(Path);
...
var DISABLE_AUTO_FETCH_LOADING_BAR_TIMEOUT = 5000;
  ...
  PDFJS.imageResourcesPath = Path + 'pdf/web/images/';
  PDFJS.workerSrc = Path + 'pdf/build/pdf.worker.js';
  PDFJS.cMapUrl = Path + 'pdf/web/cmaps/';
