<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
	CodeFile="ManageOrderStatus.aspx.cs" Inherits="ManageOrderStatus" Title="Order Status" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<asp:Label ID="lblOrderStatusId" runat="server" Visible="false"></asp:Label>
			<div class="row">
				...
				<div class="page-content col-md-12 divtable divloader">
					<div class="table-responsive tabHeight1 fixheight2">
						<asp:GridView ID="grdOrderStatus" AllowPaging="false" runat="server" OnRowDataBound="grdOrderStatus_OnRowDataBound"
							OnSelectedIndexChanged="grdOrderStatus_OnSelectedIndexChanged" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundField DataField="OrderStatusId" HeaderText="OrderStatusId" HeaderStyle-CssClass="hide"
								...
								<asp:TemplateField HeaderText="Status Name">
									<ItemTemplate>
										<asp:LinkButton ID="lnkEditOrderStatus" CssClass="lnkEditOrderStatus" OnClick="lnkEditOrderStatus_OnClick"
								...
								<asp:TemplateField HeaderText="Type">
									<ItemTemplate>
										<asp:Literal ID="ltrStatusType" runat="server"></asp:Literal>
									</ItemTemplate>
								</asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
	<asp:UpdatePanel ID="UpdatePanel2" runat="server">
		<ContentTemplate>
			...
			<asp:LinkButton ID="lnkFackOrderStatus" runat="server"> </asp:LinkButton>
			<cc1:ModalPopupExtender ID="popupOrderStatus" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID2"
				PopupControlID="pnlpopupOrderStatus" TargetControlID="lnkFackOrderStatus" BackgroundCssClass="modalBackground">
			</cc1:ModalPopupExtender>
			<asp:Panel ID="pnlpopupOrderStatus" runat="server" DefaultButton="btnSave" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
				Style="display: none">
					...
					<div class="modal-content darkmodel">
						<div class="modal-header bg-black">
							...
							<h4 class="modal-title">
								<asp:Label ID="lblPopupTitle" runat="server">Order Status</asp:Label></h4>
						</div>
						<div class="modal-body divloaderOrderStatus checkvalidOrderStatusDetail">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-8 col-md-8 col-sm-7">
											<asp:TextBox ID="txtStatusName" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=OrderStatus Name"
												runat="server" MaxLength="50" placeholder="Enter OrderStatus"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-8 col-md-8 col-sm-7">
											<asp:TextBox ID="txtSerialNo" CssClass="form-control intnumber" ZValidation="e=blur|v=IsNumber|m=Serial No"
												runat="server" MaxLength="5" placeholder="Enter Serial No"></asp:TextBox>
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-8 col-md-8 col-sm-7">
											<asp:DropDownList ID="ddleStatusType" CssClass="form-control" ZValidation="e=change|v=IsSelect|m=Status Type"
												runat="server">
											</asp:DropDownList>
										</div>
									</div>
	...
	<script type="text/javascript">
		function AddControl() {
			if ($(".lnkAdd").attr("class") != undefined) {
				...
				ShowPopupAndLoader(2, "divloaderOrderStatus");
				return true;
			}
			else {
				return false;
		...
		function Checkpostback() {
			...
			$(".lnkEditOrderStatus").click(function () {
				ShowPopupAndLoader(2, "divloaderOrderStatus");
				return true;
			});

			$(".btnSave").click(function () {
				if (CheckValidation("checkvalidOrderStatusDetail")) {
					addLoader('btnSave');
					return true;
				}
				else {
