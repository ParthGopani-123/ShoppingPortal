<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageUser.aspx.cs" Inherits="ManageUser" EnableEventValidation="false"
    Title="User" %>
...
<%@ Register Src="~/CCManageUser.ascx" TagName="ManageUserCC" TagPrefix="MC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:TextBox ID="txtUsersId" runat="server" CssClass="hidden txtUsersId" Text=""></asp:TextBox>
            <div id="divUser" runat="server" class="row">
                <div class="page-header clearfix">
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 p0">
                        <div class="btn-group">
                            <asp:LinkButton ID="lnkAdd" ToolTip="Add (alt+n)" runat="server" OnClick="lnkAdd_OnClick"
                                CssClass="lnkAdd lnkOpenUser btn btngroup btn-add tooltips" data-toggle="tooltip">
                            <i class="fa fa-plus"></i>
                            </asp:LinkButton>
                            <asp:LinkButton ID="lnkEdit" ToolTip="Edit (alt+u)" allowon="1" runat="server" OnClick="lnkEdit_OnClick"
                                CssClass="lnkEdit lnkOpenUser btn btngroup btn-edit tooltips" data-toggle="tooltip">
                    ...
                    <div note-colspan="note-colspan-class" class="search-tools divShowSearch note-colspan-class">
                        <asp:Panel ID="pnlSearch" runat="server" DefaultButton="lnkSearch" class="divsearchloader"
                            ...
                            <div id="divorganization" runat="server" class="padbm" note-colspan="note-colspan-class">
                                <asp:DropDownList ID="ddlOrganization" CssClass="form-control" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlOrganization_SelectedIndexChanged"
                            ...
                            <div id="divFirm" runat="server" class="padbm" note-colspan="note-colspan-class">
                                <asp:DropDownList ID="ddlFirm" CssClass="form-control" runat="server" note-colspan="note-colspan-class">
                                </asp:DropDownList>
                            </div>
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdUser" AllowPaging="false" runat="server" OnRowDataBound="grdUser_OnRowDataBound"
                            OnSelectedIndexChanged="grdUser_OnSelectedIndexChanged" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="UsersId" HeaderText="UsersId" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:TemplateField HeaderText="Name">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkUser" CssClass="lnkUser lnkOpenUser" OnClick="lnkEditUser_OnClick"
                                            runat="server"></asp:LinkButton><br />
                                        <asp:LinkButton ID="lnkMobile" CssClass="lnkMobile fontblue" runat="server"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="" HeaderText="Contact" />
                            </Columns>
                            <EmptyDataTemplate>
            ...
            <asp:Panel ID="pnlAuthority" runat="server" class="row">
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
    ...
    <asp:LinkButton ID="lnkFackUser" runat="server"> </asp:LinkButton>
    <cc1:ModalPopupExtender ID="popupUser" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID2"
        PopupControlID="pnlUser" TargetControlID="lnkFackUser" BackgroundCssClass="modalBackground">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="pnlUser" runat="server" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
        Style="display: none">
        <MC:ManageUserCC ID="ManageUserCC" runat="server" />
    </asp:Panel>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="script" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Checkpostback() {
            $(".lnkOpenUser").click(function () {
                ShowPopupAndLoader(2, "div-loader-User");
                return true;
            });
        }
    </script>
