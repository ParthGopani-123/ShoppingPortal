<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManagePortal.aspx.cs" Inherits="ManagePortal" Title="Portal" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Label ID="lblPortalId" runat="server" Visible="false" Text=""></asp:Label>
            <div class="row">
                <div class="page-header clearfix">
                    ...
                    <div note-colspan="note-colspan-class" class="search-tools divShowSearch note-colspan-class">
                        <asp:Panel ID="pnlSearch" runat="server" DefaultButton="lnkSearch" class="divsearchloader" note-colspan="note-colspan-class">
                            <div class="padbm" note-colspan="note-colspan-class">
                                <asp:DropDownList ID="ddlSearchPortal" CssClass="form-control" runat="server" note-colspan="note-colspan-class">
                                </asp:DropDownList>
                            </div>
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdPortal" AllowPaging="false" runat="server" OnRowDataBound="grdPortal_OnRowDataBound"
                            OnSelectedIndexChanged="grdPortal_OnSelectedIndexChanged1" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PortalId" HeaderText="PortalId" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:TemplateField HeaderText="Portal">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditPortal" CssClass="lnkEditPortal" OnClick="lnkEditPortal_OnClick"
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
    ...
    <asp:LinkButton ID="lnkFackPortal" runat="server"> </asp:LinkButton>
    <cc1:ModalPopupExtender ID="popupPortal" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID2"
        PopupControlID="pnlpopupPortal" TargetControlID="lnkFackPortal" BackgroundCssClass="modalBackground">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="pnlpopupPortal" runat="server" DefaultButton="btnSavePortal" CssClass="modelpopup col-lg-4 col-md-4 col-sm-8 col-xs-12 p0"
        Style="display: none">
            ...
            <div class="modal-content darkmodel">
                <div class="modal-header bg-black">
                    ...
                    <h4 class="modal-title">
                        <asp:Label ID="lblPopupTitle" runat="server">Portal</asp:Label></h4>
                </div>
                <div class="modal-body divloaderPortal div-check-validation-Portal">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-7">
                                <asp:DropDownList ID="ddlPortal" CssClass="form-control" ZValidation="e=change|v=IsSelect|m=Portal" runat="server">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-7">
                                <asp:TextBox ID="txtStoreName" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=Portal Name"
                                    runat="server" MaxLength="30" placeholder="Enter Store Name"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="ClosePopup btn btn-raised btn-default">
                        Cancel</button>
                    <asp:Button ID="btnSavePortal" OnClick="btnSavePortal_Click" runat="server" CssClass="btnSavePortal btn btn-raised btn-black" Text="Save" />
                    <asp:Button ID="btnSaveAndNewPortal" OnClick="btnSaveAndNewPortal_Click" runat="server" CssClass="btnSaveAndNewPortal btn btn-raised btn-black" Text="Save & New" />
                </div>
            </div>
        </div>
    </asp:Panel>
    ...
    <script type="text/javascript">
        function AddControl() {
            if ($(".lnkAdd").attr("class") != undefined) {
                ...
                ShowPopupAndLoader(2, "divloaderportal");
                return true;
            }
            else {
                return false;
        ...
        function Checkpostback() {
            ...
            $(".lnkEditPortal").click(function () {
                ShowPopupAndLoader(2, "divloaderportal");
                return true;
            });

            $(".btnSavePortal").click(function () {
            if (CheckValidation("div-check-validation-Portal")) {
                addLoader('btnSavePortal');
                return true;
            }
            else {
                return false;
        ...
        $(".btnSaveAndNewPortal").click(function () {
            if (CheckValidation("div-check-validation-Portal")) {
                addLoader('btnSaveAndNewPortal');
                return true;
            }
            else {
                return false;
