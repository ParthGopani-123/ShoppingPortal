<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageOrderSource.aspx.cs" Inherits="ManageOrderSource" Title="OrderSource" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Label ID="lbltabHeightSmall1" runat="server" CssClass="lbltabHeightSmall1 hidden"
                Text="190"></asp:Label>
            <asp:Label ID="lblOrderSourceId" runat="server" Visible="false"></asp:Label>
            <div class="row">
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdOrderSource" AllowPaging="false" runat="server" OnRowDataBound="grdOrderSource_RowDataBound"
                            OnSelectedIndexChanged="grdOrderSource_SelectedIndexChanged" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="OrderSourceId" HeaderText="OrderSourceId" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:TemplateField HeaderText="Order Source">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditOrderSource" CssClass="lnkEditOrderSource" OnClick="lnkEditOrderSource_Click"
                                            runat="server"></asp:LinkButton>
                                        <asp:Literal ID="ltrOrderSource" runat="server"></asp:Literal>
                                    </ItemTemplate>
                                </asp:TemplateField>
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:LinkButton ID="lnkFackOrderSource" runat="server"> </asp:LinkButton>
            <cc1:ModalPopupExtender ID="popupOrderSource" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID2"
                PopupControlID="pnlpopupOrderSource" TargetControlID="lnkFackOrderSource" BackgroundCssClass="modalBackground">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="pnlpopupOrderSource" runat="server" DefaultButton="btnSave" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
                Style="display: none">
                    ...
                    <div class="modal-content darkmodel">
                        <div class="modal-header bg-black">
                            ...
                            <h4 class="modal-title">
                                <asp:Label ID="lblPopupTitle" runat="server">Order Source</asp:Label></h4>
                        </div>
                        <div class="modal-body divloaderOrderSource checkvalidOrderSource">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-7">
                                            <asp:TextBox ID="txtOrderSourceName" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=Order Source"
                                                runat="server" MaxLength="50" placeholder="Enter Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-7">
                                            <asp:TextBox ID="txtDescription" CssClass="form-control"
                                                runat="server" TextMode="MultiLine" placeholder="Enter Description"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        function AddControl() {
            if ($(".lnkAdd").attr("class") != undefined) {
                ...
                ShowPopupAndLoader(2, "divloaderOrderSource");
                return true;
            }
            else {
                return false;
        ...
        function Checkpostback() {
            ...
            $(".lnkEditFirm").click(function () {
                ShowPopupAndLoader(2, "divloaderOrderSource");
                return true;
            });

            $(".btnSave").click(function () {
                if (CheckValidation("checkvalidOrderSource")) {
                    addLoader('btnSave');
                    return true;
                }
                else {
