<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageVariant.aspx.cs" Inherits="ManageVariant" Title="Variant" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Label ID="lblVariantValueId" runat="server" Visible="false"></asp:Label>
            <asp:Panel ID="pnlVariant" runat="server" class="row">
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdVariant" AllowPaging="false" runat="server" OnRowDataBound="grdVariant_OnRowDataBound"
                            OnSelectedIndexChanged="grdVariant_OnSelectedIndexChanged" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="VariantId" HeaderText="VariantId" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:TemplateField HeaderText="Variant">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditVariant" CssClass="lnkEditVariant" OnClick="lnkEditVariant_OnClick"
            ...
            <asp:Panel ID="pnlVariantValue" runat="server" class="row">
                <div class="page-header clearfix">
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 p0">
                        <div class="btn-group">
                            <asp:LinkButton ID="lnkVariant" ToolTip="Back to Variant" runat="server" OnClick="lnkVariant_OnClick"
                                CssClass="btn btngroup btn-extra1 clickloader tooltips" data-toggle="tooltip">
                            <i class="fa fa-chevron-left"></i>
                            </asp:LinkButton>
                        </div>
                        <div class="btn-group">
                            <asp:LinkButton ID="lnkAddValue" ToolTip="Add (alt+n)" runat="server" OnClick="lnkAddValue_OnClick"
                                CssClass="lnkAddValue btn btngroup btn-add tooltips" data-toggle="tooltip">
                            <i class="fa fa-plus"></i>
                            </asp:LinkButton>
                            <asp:LinkButton ID="lnkEditValue" ToolTip="Edit (alt+u)" allowon="1" runat="server" OnClick="lnkEditValue_OnClick"
                                CssClass="lnkEditValue btn btngroup btn-edit tooltips" data-toggle="tooltip">
                            <i class="fa fa-edit"></i>
                            </asp:LinkButton>
                            <asp:LinkButton ID="lnkDeleteValue" ToolTip="Delete (alt+x)" allowon="1" runat="server"
                                OnClick="lnkDeleteValue_OnClick" CssClass="lnkDeleteValue btn btngroup btn-delete tooltips clickloader"
                                data-toggle="tooltip">
                            <i class="fa fa-trash-o"></i>
                            </asp:LinkButton>
                ...
                <div class="page-content col-md-12 divtable divloader">
                    <div class="table-responsive tabHeight1 fixheight2">
                        <asp:GridView ID="grdVariantValue" AllowPaging="false" runat="server" OnRowDataBound="grdVariantValue_OnRowDataBound"
                            OnSelectedIndexChanged="grdVariantValue_OnSelectedIndexChanged" AutoGenerateColumns="False"
                            class="table table-bordered table-hover nomargin selectonrowclick rowloader fixheader">
                            <Columns>
                                <asp:TemplateField HeaderStyle-CssClass="hide" ItemStyle-CssClass="hide">
                                    <ItemTemplate>
                                ...
                                <asp:BoundField DataField="VariantValueId" HeaderText="VariantValueId" HeaderStyle-CssClass="hide"
                                    ItemStyle-CssClass="hide" />
                                <asp:TemplateField HeaderText="Variant">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditVariantValue" CssClass="lnkEditVariantValue" OnClick="lnkEditVariantValue_OnClick"
                                            runat="server"></asp:LinkButton>
                                        <asp:Literal ID="ltrVariantValue" runat="server"></asp:Literal>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            <EmptyDataTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:LinkButton ID="lnkFakeConfirmationValue" runat="server"></asp:LinkButton>
            <cc1:ModalPopupExtender ID="popupConfirmationValue" runat="server" DropShadow="false"
                PopupControlID="pnlConfirmationValue" BehaviorID="PopupBehaviorID2" TargetControlID="lnkFakeConfirmationValue"
                BackgroundCssClass="modalBackground">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="pnlConfirmationValue" CssClass="modal-content zoomIn modal-confirmation col-xs-12 col-sm-12 col-md-12 p0"
                Style="display: none" runat="server">
                <CP:ConfirmationPopup ID="ConfirmationpopupValue" runat="server" />
            </asp:Panel>

            <asp:LinkButton ID="lnkFackVariant" runat="server"></asp:LinkButton>
            <cc1:ModalPopupExtender ID="popupVariant" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID3"
                PopupControlID="pnlpopupVariant" TargetControlID="lnkFackVariant" BackgroundCssClass="modalBackground">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="pnlpopupVariant" runat="server" DefaultButton="btnSave" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
                Style="display: none">
                    ...
                    <div class="modal-content darkmodel">
                        <div class="modal-header bg-black">
                            ...
                            <h4 class="modal-title">
                                <asp:Label ID="lblPopupTitle" runat="server">Variant</asp:Label></h4>
                        </div>
                        <div class="modal-body divloaderVariant checkvalidVariantDetail">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-7">
                                            <asp:TextBox ID="txtVariantName" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=Variant Name"
                                                runat="server" MaxLength="50" placeholder="Enter Variant"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-4">
                                            <div class="checkbox-custom">
                                                <asp:RadioButton ID="rbtnVarient" runat="server" CssClass="chk" Text="Varient" GroupName="rbtnType" />
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-4">
                                            <div class="checkbox-custom">
                                                <asp:RadioButton ID="rbtnSearchOnly" runat="server" CssClass="chk" Text="For Search Only" GroupName="rbtnType" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <asp:LinkButton ID="lnkFackVariantValue" runat="server"></asp:LinkButton>
            <cc1:ModalPopupExtender ID="popupVariantValue" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID4"
                PopupControlID="pnlpopupVariantValue" TargetControlID="lnkFackVariantValue" BackgroundCssClass="modalBackground">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="pnlpopupVariantValue" runat="server" DefaultButton="btnSaveValue" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
                Style="display: none">
                <div class="modal-dialog">
                    <div class="modal-content darkmodel">
                        <div class="modal-header bg-black">
                            <button type="button" class="ClosePopup close">×</button>
                            <h4 class="modal-title">Variant Value</h4>
                        </div>
                        <div class="modal-body divloaderVariantValue checkvalidVariantValueDetail">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-lg-3 col-md-3 col-sm-4 control-label">
                                            Variant Value<span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-8 col-md-8 col-sm-7">
                                            <asp:TextBox ID="txtVariantValue" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=VariantValue Name"
                                                runat="server" MaxLength="50" placeholder="Enter Variant Value"></asp:TextBox>
                                            <asp:Label ID="lblVariantValueNote" runat="server" class="VariantValueNote">Multiple Variant Separated by Comma(,)</asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="ClosePopup btn btn-raised btn-default">
                                Cancel</button>
                            <asp:Button ID="btnSaveValue" OnClick="btnSaveValue_OnClick" runat="server" CssClass="btnSaveValue btn btn-raised btn-black"
                                Text="Save" />
                            <asp:Button ID="btnSaveAndNewValue" OnClick="btnSaveAndNewValue_OnClick" runat="server"
                                CssClass="btnSaveAndNewValue btn btn-raised btn-black" Text="Save & New" />
                        </div>
                    </div>
                </div>
            </asp:Panel>
    ...
    <script type="text/javascript">
        function AddControl() {
            if ($(".lnkAdd").attr("class") != undefined) {
                ...
                ShowPopupAndLoader(3, "divloaderVariant");
                return true;
            }
            else {
                <%= Page.ClientScript.GetPostBackEventReference(lnkAddValue, String.Empty) %>;
                ShowPopupAndLoader(4, "divloaderVariantValue");
                return true;
            }
        }
        ...
        function EditControl() {
            if ($(".lnkEdit").attr("class") != undefined) {
                if (IsValidRowSelection()) {
                    ...
                    <%= Page.ClientScript.GetPostBackEventReference(lnkEditValue, String.Empty) %>;
                    ShowPopupAndLoader(3, "divloaderVariantValue");
                    return true;
                }
            }
            else {
        ...
        function DeleteControl() {
            if ($(".lnkDelete").attr("class") != undefined) {
                ...
                addLoader('lnkDeleteValue');
			    <%= Page.ClientScript.GetPostBackEventReference(lnkDeleteValue, String.Empty) %>;
            }
        }
        ...
        function Checkpostback() {
            ...
            $(".lnkEditVariant").click(function () {
                ShowPopupAndLoader(3, "divloaderVariant");
                return true;
            });

            $(".btnSave").click(function () {
                if (CheckValidation("checkvalidVariantDetail")) {
                    addLoader('btnSave');
                    return true;
                }
                else {
            ...
            $(".lnkAddValue").click(function () {
                ShowPopupAndLoader(4, "divloaderVariantValue");
                return true;
            });

            $(".lnkEditValue").click(function () {
                ShowPopupAndLoader(4, "divloaderVariantValue");
                return true;
            });

            $(".lnkEditVariantValue").click(function () {
                ShowPopupAndLoader(4, "divloaderVariantValue");
                return true;
            });

            $(".btnSaveValue").click(function () {
                if (CheckValidation("checkvalidVariantValueDetail")) {
                    addLoader('btnSaveValue');
                    return true;
                }
                else {
                    return false;
            ...
            $(".btnSaveAndNewValue").click(function () {
                if (CheckValidation("checkvalidVariantValueDetail")) {
                    addLoader('btnSaveAndNewValue');
                    return true;
                }
                else {
                    return false;
