<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
	CodeFile="ManageBankAccount.aspx.cs" Inherits="ManageBankAccount" Title="Bank Account" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			...
			<asp:Label ID="lblBankAccountId" runat="server" Visible="false"></asp:Label>
			<div class="row">
				...
				<div class="page-content col-md-12 divtable divloader">
					<div class="table-responsive tabHeight1 fixheight2">
						<asp:GridView ID="grdBankAccount" AllowPaging="false" runat="server" OnRowDataBound="grdBankAccount_OnRowDataBound"
							OnSelectedIndexChanged="grdBankAccount_OnSelectedIndexChanged" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundField DataField="BankAccountId" HeaderText="BankAccountId" HeaderStyle-CssClass="hide"
									ItemStyle-CssClass="hide" />
								<asp:BoundField DataField="eStatus" HeaderText="eStatus" HeaderStyle-CssClass="hide"
									ItemStyle-CssClass="hide" />
								<asp:TemplateField HeaderText="Account">
									<ItemTemplate>
										<asp:LinkButton ID="lnkEditBankAccount" CssClass="lnkEditBankAccount" OnClick="lnkEditBankAccount_OnClick"
											runat="server"></asp:LinkButton>
										<asp:Literal ID="ltrBankAccount" runat="server"></asp:Literal>
									</ItemTemplate>
								</asp:TemplateField>
							</Columns>
							<EmptyDataTemplate>
...
<asp:Content ID="Content3" ContentPlaceHolderID="popup" runat="Server">
	<asp:UpdatePanel ID="UpdatePanel2" runat="server">
		<ContentTemplate>
			...
			<asp:LinkButton ID="lnkFackBankAccount" runat="server"> </asp:LinkButton>
			<cc1:ModalPopupExtender ID="popupBankAccount" runat="server" DropShadow="false" BehaviorID="PopupBehaviorID2"
				PopupControlID="pnlpopupBankAccount" TargetControlID="lnkFackBankAccount" BackgroundCssClass="modalBackground">
			</cc1:ModalPopupExtender>
			<asp:Panel ID="pnlpopupBankAccount" runat="server" DefaultButton="btnSave" CssClass="modelpopup col-lg-6 col-md-6 col-sm-8 col-xs-12 p0"
				Style="display: none">
					...
					<div class="modal-content darkmodel">
						<div class="modal-header bg-black">
							...
							<h4 class="modal-title">
								<asp:Label ID="lblPopupTitle" runat="server">BankAccount</asp:Label></h4>
						</div>
						<div class="modal-body divloaderBankAccount checkvalidBankAccountDetail">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-lg-8 col-md-8 col-sm-7">
											<asp:TextBox ID="txtBankAccountName" CssClass="form-control" ZValidation="e=blur|v=IsRequired|m=BankAccount Name"
												runat="server" MaxLength="50" placeholder="Enter BankAccount"></asp:TextBox>
										</div>
									</div>
								</div>
							</div>
	...
	<script type="text/javascript">
		function AddControl() {
			if ($(".lnkAdd").attr("class") != undefined) {
				...
				ShowPopupAndLoader(2, "divloaderBankAccount");
				return true;
			}
			else {
				return false;
		...
		function Checkpostback() {
			...
			$(".btnSave").click(function () {
				if (CheckValidation("checkvalidBankAccountDetail")) {
					addLoader('btnSave');
					return true;
				}
				else {
